...
public class ResultResponse extends BaseResponse {
	...
	protected void completeRequest() {
		...
		// TODO put query params and func in separate class
...
//		}
		...
		if (query != null) {
			...
			if (view >= 8 && query.getGroup().length() == 0)
				...
				this.getContext().put("counting", counting);
	...
	//		TODO add reload mechanism to stylesheet (directly to BLS)
			this.getContext().put("result", html);
			this.getContext().put("query_id", query.getId());
