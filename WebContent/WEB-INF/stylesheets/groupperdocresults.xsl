											...
											<div class="inline-concordance">
												<button class="btn btn-link">
													<xsl:attribute name="onclick">
														...
														<xsl:text>','</xsl:text>
														<xsl:value-of select="$query" />
														<xsl:text>',true); document.location.href = '</xsl:text><xsl:value-of select="$context_root" /><xsl:text>search/results?query='+cql+'&amp;view=2&amp;from=4&amp;</xsl:text>
														<xsl:value-of select="$query_filter" />
														<xsl:text>';</xsl:text>
													</xsl:attribute>
												...
												<button class="btn btn-link nolink">
													<xsl:attribute name="onclick">
														...
														<xsl:text>','</xsl:text>
														<xsl:value-of select="$query" />
														<xsl:text>',true); Whitelab.search.result.docGroupContent('#</xsl:text>
														<xsl:value-of select="$rowId" />
														<xsl:text>','</xsl:text>
														<xsl:value-of select="$gr" />
														<xsl:text>','</xsl:text>
